...
//   }
//
// // 🚀 2. Date Picker Logic (Fixed for Dark Mode)
...
//         // We use your AppColors to determine the right colors for both modes
...
//
//               // 2. Header Text Color (Selected Date)
//               onPrimary: AppColors.WhiteColor,
//
//               // 3. Calendar Background Color
//               surface: AppColors.getCardColor(context),
//
//               // 4. Calendar Body Text Color (Days 1, 2, 3...) - THIS FIXES THE VISIBILITY
...
//         _orderFuture = _getJokes(); // Refresh to apply filter
//       });
//     }
//   }
//
...
//             try {
//               // Parse backend date string to DateTime
...
//       body: Column(
//         children: [
//           // 🚀 6. Selected Date Indicator (Without Intl package)
//           if (_selectedDate != null)
//             Container(
        ...
        return Theme(
          data: Theme.of(context).copyWith(
            colorScheme: ColorScheme.fromSeed(
              ...
              onPrimary: AppColors.WhiteColor,
              surface: AppColors.getCardColor(context),
              onSurface: AppColors.getTextColor(context), // Fixes text visibility
            ),
            dialogBackgroundColor: AppColors.getCardColor(context),
            textButtonTheme: TextButtonThemeData(
              style: TextButton.styleFrom(
