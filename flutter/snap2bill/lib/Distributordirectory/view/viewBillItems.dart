...
//   String? serverIp;
//   List<dynamic> _items = [];
//   List<dynamic> _allUnits = []; // Store units for the dropdown
//
//   @override
//   void initState() {
//     super.initState();
...
//   }
//
//   /// 🚀 Load Units and Bill Items together
...
//   }
//
//   /// --- UPDATE LOGIC (Integrated with Role and Unit) ---
...
//         'amount': price,
//         'unit_id': unitId,
//         'role': 'distributor', // 🚀 Identify as Distributor
//       },
//     );
//
//     var js = json.decode(res.body);
