...
class viewBillItems extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const viewBillItemsSub();
  }
}

class viewBillItemsSub extends StatefulWidget {
  const viewBillItemsSub({Key? key}) : super(key: key);

  @override
  State<viewBillItemsSub> createState() => _viewBillItemsSubState();
}

class _viewBillItemsSubState extends State<viewBillItemsSub> {
  Future<List<OrderItem>> _getOrderItems() async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    String? ip = prefs.getString("ip");
    String? orderId = prefs.getString("oid"); // The specific Order ID
