      ...
      if (jsonData["data"] != null && jsonData["data"].isNotEmpty) {
        ...
        setState(() {
          _profile = DistributorProfileModel(
            ...
            item["email"].toString(),
            item["phone"].toString(),
            _joinUrl(ip, item["profile_image"].toString()),
            item["bio"].toString(),
            ...
            _joinUrl(ip, item["proof"].toString()),
          ...
          : RefreshIndicator(
              ...
              child: CustomScrollView(
                ...
                slivers: [
                  ...
                  SliverToBoxAdapter(child: _buildTabSwitcher(theme, isDark)),
                  SliverFillRemaining(
                    child: PageView(
        ...
        children: [
                  ...
                  child: Hero(
                    ...
                    child: CircleAvatar(
                      ...
                      backgroundColor: isDark
                          ? Colors.grey[900]
                          : Colors.grey[100],
                      backgroundImage: _profile!.profile_image.isNotEmpty
                          ? CachedNetworkImageProvider(_profile!.profile_image)
                          : null,
                      // 🚀 HUGE ICON
                      child: _profile!.profile_image.isEmpty
                          ? const HugeIcon(
              ...
              Expanded(
                child: Row(
                  ...
                  children: [
                    ...
                    _StatItem(label: "Customers", count: _profile?.customer_count ?? "0", color: textColor),
                  ],
                ),
              ),
            ],
          ...
          Row(
            children: [
              ...
              // 🚀 HUGE ICON
              HugeIcon(
                icon: HugeIcons.strokeRoundedStoreVerified01,
                ...
                Expanded(
                  child: SecondaryButton(
                    ...
                    onPressed: () => Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (_) => edit_distributor_profile_sub(
                          id: _profile!.id,
                          name: _profile!.name,
      ...
      child: Column(
        children: [
          ...
          _InfoItem(
            ...
            value: "${_profile!.address}, ${_profile!.place}",
            color: textColor,
          ),
          _InfoItem(
      ...
      builder: (_) => Dialog(
        child: InteractiveViewer(
          child: CachedNetworkImage(
            imageUrl: url,
            errorWidget: (c, e, s) =>
                const Center(child: Text("No proof found")),
          ),
        ),
      ),
    );
    ...
    return Padding(
      ...
      child: Row(
        children: [
          ...
          HugeIcon(
            icon: icon,
            color: AppColors.getIconColor(context).withValues(alpha: 0.8),
            size: 24,
          ),
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  value.isEmpty || value == "null" ? "Not Provided" : value,
                  style: TextStyle(
                    color: color,
                    fontSize: 15,
