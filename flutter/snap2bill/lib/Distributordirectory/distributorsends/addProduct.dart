...
// import '../../widgets/app_button.dart'; // 🚀 Added AppButton import
//
...
//   List<Map<String, dynamic>> unitList = []; // 🚀 Unit list
//   String? selectedCategory;
//   String? selectedUnit; // 🚀 Unit selector
//
//   @override
//   void initState() {
//     super.initState();
//     loadCategory();
//     loadUnits(); // 🚀 Load units on init
...
//       if (decode['status'] == 'ok') {
//         setState(() {
//           categoryList = List<Map<String, dynamic>>.from(decode['data']);
//         });
//       }
...
//                   TextField(controller: product_name, decoration: _getDecoration('Product Name', Icons.shopping_bag_outlined, isDark)),
//                   const SizedBox(height: 15),
//                   TextField(controller: price, keyboardType: TextInputType.number, decoration: _getDecoration('Price', Icons.currency_rupee, isDark)),
//                   const SizedBox(height: 15),
//                   Row(
//                     children: [
//                       Expanded(child: TextField(controller: quantity, keyboardType: TextInputType.number, decoration: _getDecoration('Stock Qty', Icons.inventory_2_outlined, isDark))),
...
//                         items: categoryList.map((c) => DropdownMenuItem(value: c['id'].toString(), child: Text(c['category_name']))).toList(),
//                       ),
//                     ),
//                   ),
//                   const SizedBox(height: 15),
//                   TextField(controller: description, maxLines: 3, decoration: _getDecoration('Description', Icons.description_outlined, isDark)),
//
//                 ],
//               ),
//             ),
...
//
//             // 🚀 Custom AppButton implementation
//             AppButton(
//               text: "Save Product",
...
//     if (product_name.text.isEmpty || selectedCategory == null || _selectedFile == null || selectedUnit == null) {
...
//       request.fields['unit_id'] = selectedUnit!; // 🚀 Send unit ID
...
//         Navigator.pushAndRemoveUntil(context, MaterialPageRoute(builder: (context) => DistributorNavigationBar(initialIndex: 2)), (route) => false);
//       }
//     } catch (e) { debugPrint("Error: $e"); }
