...
class _HomePageState extends State<HomePage> {
  ...
  List<DrawerItemModel> _getDrawerItems() {
    return [
      DrawerItemModel(icon: Icons.people_alt_outlined, title: "Distributors", onTap: () => const ViewDistributors()),
      DrawerItemModel(icon: Icons.inventory_2_outlined, title: "My Products", onTap: () => const MyProducts()),
      DrawerItemModel(icon: Icons.shopping_bag_outlined, title: "All Products", onTap: () => const ViewProduct()),
      DrawerItemModel(icon: Icons.list_alt, title: "Orders", onTap: () => const ViewAllOrders()),
      DrawerItemModel(icon: Icons.category_outlined, title: "Category", onTap: () => const ViewCategory()),
      DrawerItemModel(icon: Icons.feedback_outlined, title: "Feedback", onTap: () => const ViewFeedback()),
