...
class upload_page extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(home: upload_page_sub(),);
  }
}


class upload_page_sub extends StatefulWidget {
  const upload_page_sub({Key? key}) : super(key: key);

  @override
  State<upload_page_sub> createState() => _upload_page_subState();
}

class _upload_page_subState extends State<upload_page_sub> {
