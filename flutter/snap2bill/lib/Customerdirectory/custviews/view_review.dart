...
class _view_reviewState extends State<view_review> {
  ...
  Future<List<Joke>> _getJokes() async {
    ...
    String foodimage="";
    var data = await http.post(Uri.parse(prefs.getString("ip").toString()+"/view_review"),
        body: {"uid":prefs.getString("uid"),"cid":prefs.getString("cid")}
    );
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            _buildRow("Distributor:", i.distributor.toString()),
