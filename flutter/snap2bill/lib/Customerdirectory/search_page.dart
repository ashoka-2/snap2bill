...
class search_page extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(home: search_page_sub(),);
  }
}


class search_page_sub extends StatefulWidget {
  const search_page_sub({Key? key}) : super(key: key);

  @override
  State<search_page_sub> createState() => _search_page_subState();
}

class _search_page_subState extends State<search_page_sub> {
