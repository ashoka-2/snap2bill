...
class _CustomerHomePageState extends State<CustomerHomePage> {
  ...
  void _handleSwipe(DragEndDetails details) {
    // Velocity threshold (e.g., 500 units per second)
    ...
    if (details.primaryVelocity! > sensitivity) {
      ...
      // Swipe Left (Negative velocity) -> Placeholder action (to be specified later)
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text("Left Swipe Detected! Action placeholder.")),
      );
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      key: _scaffoldKey, // <<< ADDED KEY TO SCAFFOLD >>>
      backgroundColor: theme.scaffoldBackgroundColor,
      ...
      body: GestureDetector(
        onHorizontalDragEnd: _handleSwipe, // <<< ADDED GESTURE DETECTOR >>>
        child: Column(
          children: [
            // A. CATEGORIES
            Container(
