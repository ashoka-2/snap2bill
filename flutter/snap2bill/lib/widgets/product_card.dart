...
// //     super.didUpdateWidget(oldWidget);
// //     if (oldWidget.product.isLiked != widget.product.isLiked) {
// //       setState(() => isLiked = widget.product.isLiked);
// //     }
// //   }
// //
// //   void _showSnackBar(String message, Color color) {
// //     ScaffoldMessenger.of(context).showSnackBar(
// //       SnackBar(content: Text(message), backgroundColor: color, duration: const Duration(milliseconds: 800)),
// //     );
// //   }
// //
// //   Future<void> _toggleWishlistInBackend({bool fromDoubleTap = false}) async {
...
// //       SharedPreferences sh = await SharedPreferences.getInstance();
// //       var response = await http.post(
// //         Uri.parse("${sh.getString("ip")}/toggle_wishlist"),
// //         body: {'pid': widget.product.id, 'cid': sh.getString("cid") ?? "", 'uid': sh.getString("uid") ?? ""},
// //       );
// //       if (response.statusCode == 200) {
// //         setState(() => isLiked = json.decode(response.body)['action'] == 'added');
// //       }
// //     } catch (e) {
// //       _showSnackBar("Connection error!", Colors.red);
// //     } finally {
...
// //         children: [
// //           ListTile(
// //             leading: CircleAvatar(backgroundImage: NetworkImage(widget.product.distributorImage)),
// //             title: Text(widget.product.distributorName, style: const TextStyle(fontWeight: FontWeight.bold)),
// //             subtitle: Text(widget.product.distributorPhone, style: const TextStyle(fontSize: 12)),
...
// //                 ),
// //               ),
// //               if (showCenterHeart) const Icon(Icons.favorite, color: Colors.white70, size: 100),
// //               Positioned(
// //                 bottom: 12, right: 12,
// //                 child: Container(
// //                   padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 5),
...
// //               children: [
// //                 IconButton(
// //                   icon: Icon(isLiked ? Icons.favorite : Icons.favorite_border, color: isLiked ? Colors.red : textColor, size: 30),
// //                   onPressed: () => _toggleWishlistInBackend(),
// //                 ),
// //                 const Spacer(),
// //                 if (widget.showAddToCart)
// //                   ElevatedButton.icon(
// //                     style: ElevatedButton.styleFrom(backgroundColor: isDark ? AppColors.primaryDark : AppColors.primaryLight),
// //                     onPressed: () async {
// //                       SharedPreferences prefs = await SharedPreferences.getInstance();
// //                       prefs.setString("pid", widget.product.id);
// //                       prefs.setString("uid", widget.product.distributorId);
// //                       // Smooth transition navigator
// //                       Navigator.push(context, PageRouteBuilder(
// //                         transitionDuration: const Duration(milliseconds: 500),
// //                         pageBuilder: (_, __, ___) => const addOrder(),
...
// //               children: [
// //                 Text(widget.product.productName, style: const TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
// //                 ReadMoreText(widget.product.description, trimLines: 2, colorClickableText: theme.primaryColor),
// //               ],
// //             ),
// //           ),
// //         ],
                ...
                if (widget.showAddToCart)
                  ElevatedButton.icon(
                    ...
                    onPressed: () async {
                      ...
                      Navigator.push(context, PageRouteBuilder(
                        transitionDuration: const Duration(milliseconds: 500),
                        pageBuilder: (context, animation, secondaryAnimation) => const addOrder(),
