...
class _ProductCardState extends State<ProductCard> {
  ...
  /// ---------------- 3 DOT MENU ----------------
  void _showOptionsMenu(BuildContext ctx, Offset pos, Color textColor, Color bg) {
        ...
        PopupMenuItem(
          ...
          child: ListTile(
            leading: Icon(
              ...
              color: isLiked ? AppColors.getDangerColor(context) : textColor,
            ),
            title: Text(
                ...
                leading: InkWell(
                  ...
                  child: CircleAvatar(
                    ...
                    foregroundImage: widget.product.distributorImage.isNotEmpty
                        ? CachedNetworkImageProvider(widget.product.distributorImage)
                        : null,
                  ),
                ),
                    ...
                    AspectRatio(
                      ...
                      child: ClipPath(
                        ...
                        child: GestureDetector(
                          onDoubleTap: () => _toggleWishlist(fromDoubleTap: true),
                        ...
                        child: SizedBox(
                          ...
                          child: Container(
                            decoration: BoxDecoration(
                              ...
                              border: Border.all(
                                color: isLiked ?  AppColors.getDangerColor(context) .withValues(alpha: 0.5) : AppColors.getBorderColor(context),
                                width: 2,
                              ),
                            ),
                            child: IconButton(
                              icon: Icon(
                                ...
                                color: isLiked ?  AppColors.getDangerColor(context) : AppColors.getIconColor(context),
                                size: 30,
                              ),
